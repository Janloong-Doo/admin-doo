...
export default {
  ...
  setup() {
    const blog = reactive({
      // sourceContent: "# markdown-it rulezz!",
      sourceContent: "# 效果\n" +
          "\n" +
          "[oauth2](https://blog.csdn.net/j754379117/article/details/70175198)\n" +
          "\n" +
          "# 欢迎使用Markdown编辑器写博客\n" +
          "\n" +
    ...
    const initMarkDown = (content: any) => {
      // var md = require('markdown-it')();
      const md = new MarkdownIt();
      blog.targetContent = md.render(content);
