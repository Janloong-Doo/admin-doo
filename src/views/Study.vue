...
export default {
    ...
    methods: {
        ...
        requestUrl() {
            ...
            let urlParams = signMd5Utils.parseQueryString(this.requesturl);
            console.log(this.requesturl);
            ...
            urlParams.nonce = signMd5Utils.getNonce(timestamp);
            urlParams.sign = signMd5Utils.getSign(this.requesturl, urlParams);
